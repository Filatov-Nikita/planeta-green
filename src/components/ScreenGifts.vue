      ...
      <div class="gar-gift">
        <div class="gar-gift__content">
          <p class="gar-gift__title">
            Гарантированный приз каждому участнику акции
          </p>
          <p>Семена мяты, мелиссы и других растений для выращивания в домашних условиях</p>
        </div>
        <img
          width="283"
          height="283"
          class="gar-gift__img"
          src="@/assets/images/gift-for-all.png"
          alt="гарантированный приз"
        />
      </div>
    </div>
  </section>
